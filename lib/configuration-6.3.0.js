...
(function(M) {
   ...
   * @api stable
   */
  M.config('MAPEA_URL', 'https://sigc-dev.desarrollo.guadaltel.es/mapea6');
   ...
   * @api stable
   */
  M.config('PROXY_URL', 'https://sigc-dev.desarrollo.guadaltel.es/mapea6/api/proxy');
   ...
   * @api stable
   */
  M.config('THEME_URL', 'https://sigc-dev.desarrollo.guadaltel.es/mapea6/assets/');
